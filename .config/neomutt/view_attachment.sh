...
#
# Stolen from: https://bitbucket.org/sjl/dotfiles/src/tip/mutt/view_attachment.sh?fileviewer=file-view-default
#
...
if [[ "$OSTYPE" == "darwin18" ]]; then
    echo "This is a macOS system. Using the 'open' command"
    open $newfile
