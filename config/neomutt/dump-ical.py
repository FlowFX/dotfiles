#!/usr/bin/env python
#
# Found via http://simonjbeaumont.com/posts/mutt-exchange/
# Source: https://github.com/simonjbeaumont/.dotfiles/blob/ce081a65/mutt/dump-ical.py
...
def pretty_print_invitation(invitation):
    ...
    ocation = event['location'][0].value
